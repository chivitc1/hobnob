...
describe('generateValidationErrorMessage', function() {
  it('should return the correct string when error.keyword is "required"', function() {
    //dummy errors array that mimics the errors array
    const errors = [{
      keyword: 'required',
      dataPath: '.test.path',
      params: {
    ...
    const actualErrorMsg = generateValidationErrorMessage(errors);
    const expectedErrorMsg = "The '.test.path.property' field is missing";
